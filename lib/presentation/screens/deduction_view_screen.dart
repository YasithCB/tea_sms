...
class DeductionViewScreen extends StatefulWidget {
  const DeductionViewScreen({super.key});

  @override
  State<DeductionViewScreen> createState() => _DeductionViewScreenState();
}

class _DeductionViewScreenState extends State<DeductionViewScreen> {
